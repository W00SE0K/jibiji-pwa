...
export function Sidebar({
  ...
  const handleDeleteSelected = () => {
    ...
    const message =
      count === 1 ? "Delete this memo?" : `Delete ${count} memos?`;
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 overflow-y-auto px-4 pb-2">
        <div className="rounded-2xl overflow-hidden shadow-sm" 
          ...
          {filteredMemoIds.length === 0 ? (
            <div
              className="p-8 text-center text-[15px]"
              style={{ color: "var(--ios-tertiary-label)" }}
            >
              {languageFilter !== "ALL"
                ? `No ${languageFilter} memos`
                : "No memos"}
            </div>
          ) : (
              ...
              return (
                <div key={id}>
                  <div
                    ...
                    style={{
                      backgroundColor: isSelected && !isDeleteMode ? 'var(--ios-gray5)' : 'transparent'
                    }}
                    onClick={() => {
                      if (isDeleteMode) {
      ...
      {isDeleteMode && (
        <div
          className="p-4 pt-2 pb-6 flex justify-center items-center safe-area-inset-bottom backdrop-blur-xl"
          style={{ 
            backgroundColor: 'var(--ios-secondary-background)',
      ...
      {contextMenu && (
        <div
          className="fixed rounded-2xl shadow-2xl overflow-hidden z-50 animate-in fade-in zoom-in-95 duration-200"
          style={{
        ...
        >
          <button
            ...
            className="flex items-center gap-3 px-5 py-3.5 w-full text-left transition-colors"
            style={{
              backgroundColor: 'transparent',
            }}
            onMouseEnter={(e) => e.currentTarget.style.backgroundColor = 'var(--ios-gray6)'}
      ...
      {showEasterEgg && (
        ...
        >
          <div
            className="rounded-3xl p-8 mx-4 max-w-sm w-full text-center shadow-2xl animate-in fade-in zoom-in-95 duration-300"
